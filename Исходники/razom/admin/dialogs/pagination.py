# -*- coding: utf-8 -*-
"""Возвращаем клавиатуру пагинатор с данными где нужно перемещаться по страница#ID-элемента"""
import json
...
class PaginatorExtended:
    ...
    def __init__(self, page_count, action, current_page=1) -> None:
        ...
        for key in keys:
            keyboard.append(
                InlineKeyboardButton(
                    ...
                    callback_data=extended_paginator_cb.new(
                        page=key,
                        action=self.action,
